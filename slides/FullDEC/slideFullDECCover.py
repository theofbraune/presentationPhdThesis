...
class FullDECCover(Slide):
    def construct(self):

        # ----- title -----
        title = Tex(
            r"A Discrete Exterior Calculus of Bundle-Valued Forms ",
            font_size=32,
        ).to_edge(UP, buff=0.4)
        citation = Tex(
            r"\small Braune, Tong, Gay-Balmaz, Desbrun - 2024",
        ...
        paper = ImageMobject("figures/bundleDECCover.png")
        paper.height = 4.5
        ...
        FIG_Y_POSITIONS = [  -0.5]  # three vertical slots
